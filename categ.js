...
var categ = searchParams.get('categ');
function fetchDataCateg(categ) {
    return __awaiter(this, void 0, void 0, function () {
        var resp, res, carous_ele;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(categ == "all")) return [3 /*break*/, 1];
                    fetchDataCateg("men's clothing");
                    fetchDataCateg("women's clothing");
                    return [3 /*break*/, 4];
                case 1: return [4 /*yield*/, fetch("https://fakestoreapi.com/products/category/".concat(categ))];
                case 2:
                    resp = _a.sent();
                ...
                case 3:
                    ...
                    makeCards("".concat(categ), carous_ele, res);
...
function makeCards(categClass, targetEle, arrProd) {
